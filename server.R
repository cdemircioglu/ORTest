...
function(input, output, session) {
  ...
  df_duration <- data.frame(FOO=c("414060|ACCOUNTING","354580|ADD","250400|ARTS_CRAFTS","293450|BARBECUES_GRILLING","451150|EDUCATIONAL_INSTITUTIONS","664630|ENTERTAINMENT_NEWS_CELEBRITY_SITES","139870|ENTERTAINMENT_OTHER","73030|HEALTH_LOWFAT_COOKING","204910|INVESTING","412760|LITERATURE_BOOKS","237510|MOVIES","776260|MUSIC","41320|PSYCHOLOGY_PSYCHIATRY","241700|REFERENCE_MATERIALS_MAPS","29000|SMOKING_CESSATION","252130|SPECIAL_EDUCATION","199340|TAX_PLANNING","328260|TEXT_MESSAGING_SMS","160280|WIKIS","306840|YEAR_712_EDUCATION"))  
  ...
  output$totalcustomersScanned <- renderValueBox({
    ...
    if(exists("df"))
    {
      valueBox(
        #value = customerCount(),
        value = paste(prettyNum(floor(df$cmsisdn/500), scientific=FALSE, big.mark=','),"K",sep=""),
        #value = df$cmsisdn,
