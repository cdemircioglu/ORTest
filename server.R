...
function(input, output, session) {
  ...
  df_duration <- data.frame(FOO=c("114060|ACCOUNTING","54580|ADD","50400|ARTS_CRAFTS","93450|BARBECUES_GRILLING","251150|EDUCATIONAL_INSTITUTIONS","214630|ENTERTAINMENT_NEWS_CELEBRITY_SITES","139870|ENTERTAINMENT_OTHER","73030|HEALTH_LOWFAT_COOKING","204910|INVESTING","412760|LITERATURE_BOOKS","237510|MOVIES","176260|MUSIC","41320|PSYCHOLOGY_PSYCHIATRY","241700|REFERENCE_MATERIALS_MAPS","29000|SMOKING_CESSATION","252130|SPECIAL_EDUCATION","199340|TAX_PLANNING","328260|TEXT_MESSAGING_SMS","160280|WIKIS","306840|YEAR_712_EDUCATION"))  
